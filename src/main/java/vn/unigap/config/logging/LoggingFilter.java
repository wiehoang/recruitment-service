...
/** Implements request and response logging for each request. */
@Slf4j
@Component
public class LoggingFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request,
    ...
    RepeatableContentCachingRequestWrapper requestWrapper = new
            RepeatableContentCachingRequestWrapper(request);
  ...
  private void logRequest(RepeatableContentCachingRequestWrapper requestWrapper)
          throws IOException {
    ...
    if (body != null) {
      build.append("body=[").append(body).append("]");
    }
  ...
  private Map<String, String> getParameterMap(RepeatableContentCachingRequestWrapper
                                                  requestWrapper) {
