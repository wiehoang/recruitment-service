...
/**
 * The `EmployerController` class handles employer-related operations.
 * Provides endpoints for creating, editing and deleting a profile, getting employers details.
 */
